    ...
    content: [
      ...
      },
      {
        ...
        content: [
          ...
          "Build incrementally: Start very simple, add one new feature or concept per day, mastering core concepts methodically."
        ]
      },
      {
        type: "section",
        ...
        content: [
          "State management confusion (React): Initially struggled with state handling. Focusing on small, manageable examples (using useState and useEffect) clarified concepts.",
          "SSR vs. CSR (Next.js): Next.js's server-side rendering felt confusing initially. The official docs and small, isolated experiments made the differences clear.",
          "Tailwind's learning curve: Tailwind seemed unintuitive at first, but creating quick, simple layouts daily and referencing the official Tailwind cheat sheet rapidly built familiarity."
        ]
      },
      {
        type: "section",
        title: "Top resources:",
        content: [
          "React official docs & React.dev interactive tutorials.",
          "Next.js Learn Platform (nextjs.org/learn).",
          "Tailwind official documentation (tailwindcss.com/docs)."
        ]
      },
      {
        type: "paragraph",
        text: "Mastering modern frameworks quickly isn't about learning everything at once. It's about building real projects, solving actual problems, and incrementally deepening your knowledge. This approach turned me from overwhelmed beginner into confident developer in weeks—not months or years."
      }
    ]
  },
];
